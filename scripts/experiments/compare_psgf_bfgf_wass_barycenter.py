...
def main():
    ...
    if obj_name == 'dice':
        ...
        center_verts = [1000, 8000, 15000]
    elif obj_name == 'moomoo_s0':
        center_verts = [100, 300, 600]
    ...
    if obj_name == 'moomoo_s0':
        threshold_nb_vertices = 800
    elif obj_name == 'octocat-v1':
        threshold_nb_vertices = 4000
    ...
    conv_barycenter = ConvolutionalBarycenter(niter = args.niter, tol = args.tol, verb=args.verb, normalization=True)
    start_time = time.time()
    ...
    print('mean squared error', mean_squared_error(barycenter_brute_force, barycenter_psgf))
